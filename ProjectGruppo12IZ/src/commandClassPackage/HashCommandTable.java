...
public class HashCommandTable{
     ...
     * @param collector the collection containing the operands inserted.
     ...
     */
    public boolean createPersonalizedCommand(String sequenceDefinition, String operationName) throws ClassNotFoundException, NoSuchMethodException, InstantiationException, IllegalAccessException, IllegalArgumentException, InvocationTargetException{
